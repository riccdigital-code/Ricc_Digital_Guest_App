...
const services: {
...
}[] = [
  {
    ...
    icon: Bath,
    title: "Fresh Towels",
    subtitle: "Plush Egyptian cotton, delivered in minutes",
    options: ["Bath", "Hand", "Pool", "Robe & Slippers"],
  },
  {
    id: "cleaning",
    icon: BedDouble,
    title: "Housekeeping",
    subtitle: "Turndown, refresh or full service",
    options: ["Quick Refresh", "Full Turndown", "Deep Clean", "Linen Change"],
  },
  {
    id: "food",
    icon: UtensilsCrossed,
    title: "In-Room Dining",
    subtitle: "Curated by our Michelin-trained kitchen",
    options: ["Breakfast", "Lunch", "Dinner", "Champagne Service"],
  },
  {
    id: "maintenance",
    icon: Wrench,
    title: "Maintenance",
    subtitle: "Discreet, swift, white-glove repairs",
    options: ["Climate Control", "Lighting", "Plumbing", "Electronics"],
  },
];
        ...
        <Panel title={`Request — ${svc.title}`}>
              ...
              <button
                ...
                className={cn(
                  ...
                  selected === o
                    ...
                    : "bg-background/50 hover:bg-accent/40",
                )}
              >
                {o}
              </button>
          ...
          <div className="mt-5 flex flex-wrap items-center justify-between gap-3">
            <div className="text-xs text-muted-foreground">
              {selected ? (
                <>
                  Sending: <span className="text-primary">{selected}</span>
                </>
              ) : (
            ...
            >
              {sent ? (
                <>
                  <Check className="h-4 w-4" /> Request Confirmed
                </>
              ) : (
                "Send Request"
              )}
