...
export const myTasks = [
  { id: "T-441", room: "1402", title: "Replace bath linens & restock minibar", priority: "normal", due: "12 min", progress: 60, status: "in_progress" as const },
  { id: "T-440", room: "1208", title: "VIP turndown — orchid & truffle service", priority: "vip",    due: "25 min", progress: 20, status: "assigned" as const },
  { id: "T-439", room: "0908", title: "Deep clean post-checkout",               priority: "normal", due: "40 min", progress: 0,  status: "pending" as const },
  { id: "T-438", room: "0317", title: "Confirm HVAC repair with engineering",   priority: "high",   due: "5 min",  progress: 80, status: "escalated" as const },
];
