...
INSERT INTO "new_Task" ("assignedToId", "createdAt", "id", "itemName", "orderItemId", "priority", "propertyId", "requestId", "status") SELECT "assignedToId", "createdAt", "id", "itemName", "orderItemId", "priority", "propertyId", "requestId", "status" FROM "Task";
DROP TABLE "Task";
